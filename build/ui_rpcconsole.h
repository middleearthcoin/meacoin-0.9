...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "MiddleEarthCoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "MiddleEarthCoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the MiddleEarthCoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Bitcoin-Qt help message to get a list with possible MiddleEarthCoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
