...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MiddleEarthCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>MiddleEarthCoin</b> version", 0));
